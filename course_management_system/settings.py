...
SECRET_KEY = 'django-insecure-8@nz#64h)b6i=r4l0nsk(zk^s@6s7sy5yis!uok-ao$818)u3y'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['templates','adminapp/templates','faculty/templates','student/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
'NAME': 'course_mangement_system',
'USER': 'postgres',
'PASSWORD': 'Naveen@13419',
'HOST':'localhost',
'PORT':'4444',
}}
# Password validation
